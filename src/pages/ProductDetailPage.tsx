...
import { ArrowLeft, Loader, Settings, HelpCircle, ShieldAlert, Award } from 'lucide-react';
      ...
      <div className="min-h-screen bg-ivory flex flex-col">
        ...
        <main className="flex-grow flex items-center justify-center pt-32 px-4">
          <div className="text-center max-w-md bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            ...
            <Link
              to="/shop"
              className="bg-flame-700 hover:bg-flame-600 text-white font-semibold px-6 py-2.5 rounded-lg text-sm transition-colors inline-flex items-center gap-2"
            >
    ...
    <div className="min-h-screen bg-ivory flex flex-col">
      ...
      <main className="flex-grow pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Link
            to="/shop"
            className="inline-flex items-center gap-2 text-sm font-semibold text-gray-600 hover:text-flame-700 transition-colors mb-8"
          >
            <ArrowLeft className="w-4 h-4" />
            Back to Catalog
          </Link>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-12">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              {specList.length > 0 && (
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                  <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 flex items-center gap-2">
                    <Settings className="w-4 h-4 text-flame-700" />
              ...
              {product.howToUse && (
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                  <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 flex items-center gap-2">
                    <HelpCircle className="w-4 h-4 text-flame-700" />
                    How to Operate / Use
                  </h3>
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm space-y-5">
                <div>
                  <span className="px-3 py-1 text-xs font-semibold rounded-full bg-flame-50 text-flame-700 border border-flame-100">
                    {product.category}
                  </span>
                  ...
                  {product.price ? (
                    <p className="text-xl font-extrabold text-flame-700">{product.price}</p>
                  ) : (
              ...
              {product.essay && (
                <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm space-y-6">
                  <h2 className="text-lg font-bold text-gray-900 uppercase tracking-wider border-b border-gray-150 pb-3 flex items-center gap-2">
                    <Award className="w-5 h-5 text-flame-700" />
